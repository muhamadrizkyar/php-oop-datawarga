            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Tambah Data Warga</h1>
                            ...
                            <form action="index.php" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <label for="alamat_lengkap" class="form-label">Alamat</label>
                                        <textarea class="form-control" placeholder="Please Fill In Correctly" id="alamat_lengkap" style="height: 100px" rows="7" name="alamat_lengkap"></textarea>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary float-end" name="daftar">Submit</button>
                            </form>
                        </div>
                    </div>
